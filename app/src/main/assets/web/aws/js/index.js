    ...
    function(v, MINT, Util, index, footer, resetDevice, operateCloudDevice, addGroup, load,
        ...
        var Index = v.extend({
            ...
            methods:{
                ...
                onAWSUserLogin: function(res) {
                    console.log(res);
                    if (!Util._isEmpty(res) && res != "{}") {
                        console.log(res);
                        res = JSON.parse(res);
                        console.log("登录信息1" + res)
                        this.$store.commit("setUserInfo", res);
            ...
            created: function () {
                ...
                window.onIsAWSUserLogin = this.onIsAWSUserLogin;
                window.onGetAWSUserInfo = this.onGetAWSUserInfo;
                ...
                window.onAWSUserLogin = this.onAWSUserLogin;
            },
            components: {
                "v-footer": footer,
