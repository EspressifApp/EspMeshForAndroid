define(["vue", "MINT", "Util", "txt!../../pages/joinDevice.html", "./importDevice"],
    function(v, MINT, Util, joinDevice, importDevice) {
    ...
    var JoinDevice = v.extend({
        ...
        data: function(){
            return {
                ...
                scanOldList: [],
                scanMacs: [],
                importDeviceId: "device-import-id",
                selectDeviceAllId: "joinDevice-select-id",
                count: 0,
                selected: 0,
                searchReset: "",
                resetPairList: [],
        ...
        computed: {
            list: function () {
                ...
                if (self.addFlag) {
                    ...
                    if ($("#" + self.selectDeviceAllId).hasClass("active")) {
                        var allMacs = [];
                        $.each(list, function(i, item) {
        ...
        methods:{
            show: function() {
                ...
                self.isSelectedMacs = [];
                setTimeout(function() {
                    self.onBackJoinDevice();
                    $("#" + self.selectDeviceAllId).addClass("active");
                });
                self.scanDeviceList = [];
